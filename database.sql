...
INSERT INTO `usuario` (`nombre`, `apellido`, `fechaNac`, `latitud`, `longitud`, `genero`, `email`, `usuario`, `contraseña`, `fotoPerfil`, `record`, `puntosTotales`, `qtyPreguntas`, `qtyCorrectas`, `shareCorrecta`, `fecha_creacion`) VALUES
    ('admin', 'admin', '2003-03-20', 0, 0, 'Mascuino', 'admin@test.com', 'admin', '1234', '', 0, 0, 0, 0, 0, '2023-11-18 17:33:25'),
    ('editor', 'editor', '2000-10-10', 0, 0, 'Femenino', 'editor@test.com', 'editor', '1234', '', 0, 0, 0, 0, 0, '2023-11-18 17:33:25'),
    ('Guadalupe', 'Fernandez', '2000-06-20', 0, 0, 'Femenino', 'guadapfernandez@gmail.com', 'guada', '1234', 'public/imagen_124.jpg', 0, 0, 0, 0, 0, '2023-11-18 17:33:25'),
    ('Guadalupe', 'Fernandez', '1989-12-13', -34.6440676, -58.59564279999999, 'Femenino', 'guadapfernandez@hotmail.com', 'wada', '1234', 'public/fotosPerfil/imagen_78.jpg', 0, 0, 0, 0, 0, '2023-11-20 21:27:47');
