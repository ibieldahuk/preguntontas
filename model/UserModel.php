...
class UserModel {
    ...
    public function register($nombre, $apellido, $fechaNac, $pais, $ciudad, $genero, $email, $usuario,$contraseña, $fotoPerfil, $latitud, $longitud){
        ...
        $result=$this->database->query($sql);
           if(sizeof($result) == 1){
            return false;
               ...
               $sql = "INSERT INTO `Usuario`( `nombre`, `apellido`, `fechaNac`, `pais`, `ciudad`, `genero`, `email`, `usuario`, `contraseña`, `fotoPerfil`, `latitud`, `longitud`) 
                VALUES ( '" . $nombre . "', '" . $apellido . "', '" . $fechaNac . "','" . $pais . "', '" . $ciudad . "', '" . $genero . "', '" . $email . "','" . $usuario . "', '" . $contraseña .  "', '" . $fotoGuardada . "', '" . $latitud . "', '" . $longitud . "')";
